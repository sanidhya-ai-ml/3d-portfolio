...
const projects = [
  ...
  },
  {
    ...
    category: "Automation · Playwright · Gemini",
    description:
      "Autonomous LinkedIn Easy Apply agent — fetches listings from Apify, scores fit with Gemini 2.5 Flash, generates personalised cover letters, submits applications via Playwright, and logs everything to a colour-coded Excel sheet with email/Slack summaries.",
    tools: "Playwright · Gemini 2.5 Flash · Apify · openpyxl · Python · Pydantic",
    image: "/images/auto-apply-1.png",
    link: "https://github.com/sanidhya-ai-ml/auto-apply-agent",
  },
  {
    ...
    image: "/images/research-agent-1.png",
